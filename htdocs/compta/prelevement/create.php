...
$search_date_demande_startday 		= GETPOSTINT('search_date_demande_startday');
$search_date_demande_startmonth 	= GETPOSTINT('search_date_demande_startmonth');
$search_date_demande_startyear 		= GETPOSTINT('search_date_demande_startyear');
$search_date_demande_endday 		= GETPOSTINT('search_date_demande_endday');
$search_date_demande_endmonth 		= GETPOSTINT('search_date_demande_endmonth');
$search_date_demande_endyear 		= GETPOSTINT('search_date_demande_endyear');
